  ...
  return (
    <section className="mb-8">
      <div className="mb-4 flex items-end justify-between gap-4">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#ff3366]">AI Picks</p>
          <h2 className="mt-2 text-2xl font-semibold text-gray-900 dark:text-white sm:text-3xl">Daily Discount You&apos;ll Love</h2>
        </div>
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={() => scrollTrack('left')}
            className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-700 shadow-sm transition-colors hover:border-[#ff3366] hover:text-[#ff3366] dark:border-gray-700 dark:bg-[#1a1a1a] dark:text-gray-200"
          ...
          return (
            ...
            >
              <div className="relative p-2.5">
                ...
                <button
                  ...
                  className={`absolute right-3 top-3 z-10 inline-flex h-9 w-9 items-center justify-center rounded-full border transition-colors ${
                    inWishlist
                      ...
                      : 'border-gray-200 bg-white/95 text-gray-500 hover:border-[#ff3366] hover:text-[#ff3366] dark:border-gray-700 dark:bg-gray-900/95 dark:text-gray-300'
                  }`}
                ...
                <div className="flex h-44 items-center justify-center rounded-xl bg-gray-50 p-2.5 dark:bg-gray-900">
                  <img
                    src={product.image}
                    alt={product.name}
              ...
              <div className="px-3 pb-3">
                <h3 className="min-h-[38px] text-sm font-medium leading-5 text-gray-900 line-clamp-2 dark:text-gray-100">
                  {product.name}
                </h3>

                <div className="mt-1 flex items-center gap-1 text-[#0f8f84]">
                  {[...Array(5)].map((_, index) => (
                    <svg key={index} xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                    </svg>
                  ))}
                  <span className="ml-1 text-[11px] text-gray-500 dark:text-gray-400">(189)</span>
                </div>
                ...
                <div className="mt-2 flex items-center gap-2">
                  ...
                  <span className="rounded-full bg-pink-50 px-2 py-0.5 text-[9px] font-bold text-[#ff3366] dark:bg-[#ff3366]/10">10% OFF</span>
                </div>
