...
const CategoryProducts = () => {
  ...
  useEffect(() => {
    const fetchProductsByCategory = async () => {
      setLoading(true);
      try {
        const endpoint = showAllCategories
          ? '/products'
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [priceLimit, onlyInStock, selectedBrands, categorySlug]);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 sm:py-8">
      <div className="mb-6 sm:mb-8">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{filteredProducts.length} products found</p>
      </div>
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-5 lg:sticky lg:top-5 lg:h-[calc(100vh-2.5rem)] lg:overflow-y-auto no-scrollbar">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                disabled={maxPrice === 0}
              />
              <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Up to ${priceLimit.toFixed(2)}</p>
            </div>
